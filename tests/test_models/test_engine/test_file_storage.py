...
class TestFileStorage(unittest.TestCase):
    ...
    def test_new__and_all_methods(self):
        ...
        test_dict = {'id': '123', 'created_at': '2022-02-21T12:00:00', 'updated_at': '2022-02-21T12:00:00'}
    ...
    def test_save_method(self):
        ...
        test_dict = {'id': '123', 'created_at': '2022-02-21T12:00:00', 'updated_at': '2022-02-21T12:00:00', '__class__': 'BaseModel'}
    ...
    def test_reload_method(self):
        ...
        with open(self.file_path, "w") as file:
            file.write('{"BaseModel.123": {"id": "123", "created_at": "2022-02-21T12:00:00", "updated_at": "2022-02-21T12:00:00"}}')
